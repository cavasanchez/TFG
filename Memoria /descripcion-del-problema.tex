...
\begin{figure}[h]
	\centering
	\scalebox{.6}{\input{./diagramas/descripcion_del_problema/ejemplo1rutaexpandida.tex}}
...
\begin{figure}[]
	\centering
		\scalebox{1}{\input{./diagramas/descripcion_del_problema/ejemplo2rutasexpandidas.tex}}
